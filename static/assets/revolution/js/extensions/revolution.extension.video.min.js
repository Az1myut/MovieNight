...
!function(e) {
    ...
    jQuery.extend(!0, a, {
        preLoadAudio: function(e, t) {
            if ("stop" === a.compare_version(o).check)
                return !1;
            e.find(".tp-audiolayer").each(function() {
                var e = jQuery(this)
                  , i = {};
                0 === e.find("audio").length && (i.src = void 0 != e.data("videomp4") ? e.data("videomp4") : "",
                ...
                "auto" != i.pre && "canplaythrough" != i.pre && "canplay" != i.pre && "progress" != i.pre || (void 0 === t.audioqueue && (t.audioqueue = []),
                t.audioqueue.push(i),
                    ...
                    try {
                        if ("on" == n.forcerewind) {
                            var s = -1 == (m = t(n.videostartat))
                              , l = 1 === n.bgvideo || e.find(".tp-videoposter").length > 0;
                            (0 !== (m = -1 == m ? 0 : m) && !s || l) && (u.setCurrentTime(m),
                            u.pause())
                        }
                    } catch (e) {}
                }
        ...
        playVideo: function(e, i) {
            ...
            case "youtube":
                if (0 == e.find("iframe").length)
                    ...
                    1 == e.data("nextslideatend-triggered") && (n = -1,
            ...
            case "vimeo":
                if (0 == e.find("iframe").length)
                    ...
                    e.data("vimeoplayer") ? l = e.data("vimeoplayer") : (l = new Vimeo.Player(u),
                    e.data("vimeoplayer", l)),
                    l.getPaused() ? setTimeout(function() {
                        var a = t(e.data("videostartat"))
                          , i = e.data("currenttime");
                        i || (i = 0),
                        1 == e.data("nextslideatend-triggered") && (i = -1,
                        e.data("nextslideatend-triggered", 0)),
                ...
                if (1 != v.parent().data("metaloaded"))
                    d(c, "loadedmetadata", function(e) {
                        ...
                        var o = t(e.data("videostartat"))
                          , d = c.currentTime;
                        1 == e.data("nextslideatend-triggered") && (d = -1,
                        e.data("nextslideatend-triggered", 0)),
        ...
        prepareCoveredVideo: function(e, t) {
            if (void 0 === t.data("vimeoid") || void 0 !== t.data("vimeoplayerloaded")) {
                ...
                0 === e.conw || 0 === e.conh)
                    ...
                    void i.ifr.data("resizelistener", setTimeout(function() {
                ...
                i.ifr.hasClass("resizelistener") || (i.ifr.addClass("resizelistener"),
                jQuery(window).resize(function() {
                    a.prepareCoveredVideo(e, t),
                    clearTimeout(i.ifr.data("resizelistener")),
                    i.ifr.data("resizelistener", setTimeout(function() {
                        a.prepareCoveredVideo(e, t)
                    }, 90))
                }))
            }
        ...
        manageVideoLayer: function(e, r, n, l) {
            ...
            switch (k = !0 === u.nextslideatend ? "" : k,
            u.videotype = x,
            L) {
            case "html5":
                "controls" != w && (w = "");
                V = "video";
                "html5" == u.audio && (V = "audio",
                e.addClass("tp-audio-html5"));
                var C = "";
                ...
                "auto" == g && (r.mediapreload = !0),
                void 0 != f && "firefox" == a.get_browser().toLowerCase() && (P = P + '<source src="' + f + '" type="video/webm" />'),
                void 0 != y && (P = P + '<source src="' + y + '" type="video/mp4" />'),
                void 0 != h && (P = P + '<source src="' + h + '" type="video/ogg" />'),
                P = P + "</" + V + ">";
                var I = "";
                "true" !== b && !0 !== b || (I = '<div class="tp-video-button-wrap"><button  type="button" class="tp-video-button tp-vid-full-screen">Full-Screen</button></div>'),
                "controls" == w && (P = P + '<div class="tp-video-controls"><div class="tp-video-button-wrap"><button type="button" class="tp-video-button tp-vid-play-pause">Play</button></div><div class="tp-video-seek-bar-wrap"><input  type="range" class="tp-seek-bar" value="0"></div><div class="tp-video-button-wrap"><button  type="button" class="tp-video-button tp-vid-mute">Mute</button></div><div class="tp-video-vol-bar-wrap"><input  type="range" class="tp-volume-bar" min="0" max="1" step="0.1" value="1"></div>' + I + "</div>"),
                e.data("videomarkup", P),
                e.append(P),
                (i && 1 == e.data("disablevideoonmobile") || a.isIE(8)) && e.find(V).remove(),
                e.find(V).each(function(t) {
                    var i = this
                      , o = jQuery(this);
                    o.parent().hasClass("html5vid") || o.wrap('<div class="html5vid" style="position:relative;top:0px;left:0px;width:100%;height:100%; overflow:hidden;"></div>'),
                    1 != o.parent().data("metaloaded") && d(i, "loadedmetadata", function(e) {
                        p(e, r),
                        a.resetVideo(e, r)
                    }(e))
                });
            ...
            case "youtube":
                T = "https",
                "none" == w && -1 == (v = v.replace("controls=1", "controls=0")).toLowerCase().indexOf("controls") && (v += "&controls=0"),
                (!0 === u.videoinline || "true" === u.videoinline || 1 === u.videoinline || e.hasClass("rs-background-video-layer")) && (v += "&playsinline=1");
                ...
                var j = v.split("origin=" + T + "://")
                  , A = "";
                j.length > 1 ? (A = j[0] + "origin=" + T + "://",
                self.location.href.match(/www/gi) && !j[1].match(/www/gi) && (A += "www."),
                A += j[1]) : A = v;
            ...
            case "vimeo":
                T = "https",
                e.data("videomarkup", '<iframe src="' + T + "://player.vimeo.com/video/" + m + "?" + v + '" webkitallowfullscreen mozallowfullscreen allowfullscreen width="100%" height="100%" style="opacity:0;visibility:hidden;100%;height:100%"></iframe>')
            }
            var Q = i && "on" == e.data("noposteronmobile");
            if (void 0 != u.videoposter && u.videoposter.length > 2 && !Q)
                0 == e.find(".tp-videoposter").length && e.append('<div class="tp-videoposter noSwipe" style="cursor:pointer; position:absolute;top:0px;left:0px;width:100%;height:100%;z-index:3;background-image:url(' + u.videoposter + '); background-size:cover;background-position:center center;"></div>'),
                0 == e.find("iframe").length && e.find(".tp-videoposter").click(function() {
                    if (a.playVideo(e, r),
                    i) {
                ...
                if (i && 1 == e.data("disablevideoonmobile"))
                    return !1;
                0 != e.find("iframe").length || "youtube" != x && "vimeo" != x || (e.removeData("vimeoplayer"),
                e.append(e.data("videomarkup")),
                s(e, r, !1))
            }
            ...
            1 == e.data("bgvideo") && punchgs.TweenLite.set(e.find("video, iframe"), {
                autoAlpha: 0
            })
        }
    });
    var d = function(e, t, a) {
      ...
      , n = function(e, t) {
        if (1 == t.data("bgvideo") || 1 == t.data("forcecover")) {
            ...
            void 0 === i && i.split(":").length <= 1 && t.data("aspectratio", "16:9"),
            a.prepareCoveredVideo(e, t)
        }
    }
      , s = function(e, o, d) {
        ...
        if (g = "loop" == g || "loopandnoslidestop" == g,
        n(o, e),
        p.attr("id", m),
        ...
        1 !== e.data("videolistenerexist"))
                    ...
                    events: {
                        onStateChange: function(i) {
                            ...
                            if (i.data == YT.PlayerState.PLAYING)
                                ...
                                "mute" == e.data("volume") || a.lastToggleState(e.data("videomutetoggledby")) || !0 === o.globalmute ? C.mute() : (C.unMute(),
                                C.setVolume(parseInt(e.data("volume"), 0) || 75)),
                                o.videoplaying = !0,
                                v(e, o),
                                y ? o.c.trigger("stoptimer") : o.videoplaying = !1,
                                o.c.trigger("revolution.slide.onvideoplay", r(C, "youtube", e.data())),
                                ...
                                -1 != i.data && 3 != i.data && (o.videoplaying = !1,
                                o.tonpause = !1,
                                c(e, o),
                                d.trigger("starttimer"),
                                o.c.trigger("revolution.slide.onvideostop", r(C, "youtube", e.data())),
                                void 0 != o.currentLayerVideoIsPlaying && o.currentLayerVideoIsPlaying.attr("id") != e.attr("id") || a.unToggleState(s.videotoggledby)),
                                0 == i.data && 1 == e.data("nextslideatend") ? (l(),
                        ...
                        onReady: function(o) {
                            ...
                            if (r || a.isSafari11()) {
                                ...
                                (e.hasClass("rs-background-video-layer") || l) && (r && n || (d = !0,
                                C.setVolume(0),
                                e.data("volume", "mute"),
                                C.mute(),
                            ...
                            d || "mute" != e.data("volume") || (C.setVolume(0),
                            C.mute());
                            var u = s.videorate;
                            e.data("videostart");
                            if (e.addClass("rs-apiready"),
            ...
            case "vimeo":
                ...
                jQuery("#" + m);
                if (e.data("vimeoplayer") ? L = e.data("vimeoplayer") : (L = new Vimeo.Player(m),
                e.data("vimeoplayer", L)),
                x) {
                    var P;
                    if (V)
                        ...
                        "on" !== I && "true" !== I && !0 !== I || (k && e.data("autoplay", !1),
                        P = !0)
                    }
                    P && (L.setVolume(0),
                    e.data("volume", "mute"))
                ...
                L.on("loaded", function(t) {
                    ...
                    L.getVideoWidth().then(function(t) {
                        a.width = t,
                        void 0 !== a.width && void 0 !== a.height && (e.data("aspectratio", a.width + ":" + a.height),
                ...
                L.on("play", function(t) {
                    ...
                    o.c.trigger("revolution.slide.onvideoplay", r(L, "vimeo", e.data())),
                    o.videoplaying = !0,
                    v(e, o),
                    y ? o.c.trigger("stoptimer") : o.videoplaying = !1,
                    "mute" == e.data("volume") || a.lastToggleState(e.data("videomutetoggledby")) || !0 === o.globalmute ? L.setVolume(0) : L.setVolume(parseInt(e.data("volume"), 0) / 100 || .75),
                    a.toggleState(s.videotoggledby)
                }),
                L.on("timeupdate", function(a) {
                    var i = t(e.data("videoendat"));
                    if (e.data("currenttime", a.seconds),
                    0 != i && Math.abs(i - a.seconds) < 1 && i > a.seconds && 1 != e.data("nextslidecalled"))
                        if (g) {
                            L.play();
                            var d = t(e.data("videostartat"));
                            -1 != d && L.setCurrentTime(d)
                        } else
                            1 == e.data("nextslideatend") && (e.data("nextslideatend-triggered", 1),
                ...
                L.on("ended", function(t) {
                    ...
                    o.c.trigger("revolution.slide.onvideostop", r(L, "vimeo", e.data())),
                    1 == e.data("nextslideatend") && (e.data("nextslideatend-triggered", 1),
                    o.c.revnext()),
                    void 0 != o.currentLayerVideoIsPlaying && o.currentLayerVideoIsPlaying.attr("id") != e.attr("id") || a.unToggleState(s.videotoggledby)
                }),
            ...
            switch (s.videotype) {
            case "youtube":
                d && (s.player.playVideo(),
                -1 != _ && s.player.seekTo());
                break;
            case "vimeo":
                d && ((L = e.data("vimeoplayer")).play(),
                -1 != _ && L.seekTo(_))
            }
        }
    }
      ...
      , p = function(e, o, n) {
        ...
        if (f = "loop" == f || "loopandnoslidestop" == f,
        y.data("metaloaded", 1),
        1 != e.data("bgvideo") || "none" !== s.videoloop && !1 !== s.videoloop || (h = !1),
        void 0 == m.attr("control") && (0 != e.find(".tp-video-play-button").length || i || e.append('<div class="tp-video-play-button"><i class="revicon-right-dir"></i><span class="tp-revstop">&nbsp;</span></div>'),
        ...
        1 == e.data("forcecover") || e.hasClass("fullscreenvideo") || 1 == e.data("bgvideo"))
            if (1 == e.data("forcecover") || 1 == e.data("bgvideo")) {
                ...
                void 0 !== b && 1 != b.split(":").length || e.data("aspectratio", "16:9"),
                a.prepareCoveredVideo(o, e)
            } else
                y.addClass("fullscreenvideo");
        ...
        d(x, "mousedown", function() {
            e.addClass("seekbardragged"),
            g.pause()
        }),
        d(x, "mouseup", function() {
            e.removeClass("seekbardragged"),
            g.play()
        })),
        ...
        d(g, "timeupdate", function() {
            var a = 100 / g.duration * g.currentTime
              ...
              , d = g.currentTime;
            if (void 0 != x && (x.value = a),
            0 != i && -1 != i && Math.abs(i - d) <= .3 && i > d && 1 != e.data("nextslidecalled"))
                if (f) {
                    g.play();
                    var r = t(e.data("videostartat"));
                    -1 != r && (g.currentTime = r)
        ...
        d(g, "play", function() {
            ...
            a.is_mobile() || a.isSafari11() || (!0 === o.globalmute ? g.muted = !0 : g.muted = !1,
            t > 1 && (t /= 100),
            "mute" == t ? g.muted = !0 : void 0 != t && (g.volume = t)),
            e.addClass("videoisplaying");
            var i = "html5" == s.audio ? "audio" : "video";
            v(e, o),
            h && "audio" != i ? (o.videoplaying = !0,
            o.c.trigger("stoptimer"),
            o.c.trigger("revolution.slide.onvideoplay", r(g, "html5", s))) : (o.videoplaying = !1,
            "audio" != i && o.c.trigger("starttimer"),
            o.c.trigger("revolution.slide.onvideostop", r(g, "html5", s))),
            punchgs.TweenLite.to(e.find(".tp-videoposter"), .3, {
                autoAlpha: 0,
                force3D: "auto",
                ease: punchgs.Power3.easeInOut
        ...
        d(g, "pause", function(t) {
            ...
            c(e, o),
            "audio" != i && o.c.trigger("starttimer"),
            o.c.trigger("revolution.slide.onvideostop", r(g, "html5", e.data()));
            var d = e.find(".tp-vid-play-pause")[0];
        ...
        d(g, "ended", function() {
            ...
            o.c.trigger("revolution.slide.onvideostop", r(g, "html5", e.data())),
            !0 === e.data("nextslideatend") && g.currentTime > 0 && (1 == !o.just_called_nextslide_at_htmltimer && (e.data("nextslideatend-triggered", 1),
            o.c.revnext(),
            o.just_called_nextslide_at_htmltimer = !0),
            setTimeout(function() {
                o.just_called_nextslide_at_htmltimer = !1
      ...
      , v = function(e, t) {
        ...
        e.data("stopallvideos") && void 0 != t.playingvideos && t.playingvideos.length > 0 && (t.lastplayedvideos = jQuery.extend(!0, [], t.playingvideos),
